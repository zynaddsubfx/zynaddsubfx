...
class Resonance:public Presets
{
    public:
        ...
        //parameters
        SafeBool Penabled;     //if the ressonance is enabled
        ...
        SafeBool Pprotectthefundamental;   //the fundamental (1-st harmonic) is not damped, even it resonance function is low
