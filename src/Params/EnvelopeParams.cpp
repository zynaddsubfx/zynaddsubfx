...
#define rChangeCb if(!obj->Pfreemode) obj->converttofree(); \
    ...
    rToggle(Pforcedrelease, rShort("frcr"), rDefaultDepends(loc),
            rPresetAtMulti(true, ad_global_amp, ad_global_filter, ad_voice_amp,
                                 ad_voice_fm_amp, ad_voice_fm_wave, sub_filter),
            rDefault(false),
    ...
    rParamF(D_dt,  rShort("d.dt"), rLogWithLogmin(0.f, 41.0f, 0.0001f),
              ...
              rPreset(ad_voice_fm_amp, 3.620f),  rPreset(ad_voice_fm_wave, 2.0f),
    ...
    rParamZyn(PS_val, rShort("s.val"),
              ...
              rPresetAtMulti(127, ad_global_amp, ad_voice_amp, ad_voice_fm_amp, ad_voice_fm_wave),
              "Sustain Value"),
...
#define rChangeCb if(!obj->Pfreemode) obj->converttofree(); \
    ...
    rArrayF(envdt, MAX_ENVELOPE_POINTS, rProp(parameter),
            ...
            rPreset(ad_voice_fm_wave, [0.00 (0x0p+0) 3.00 (0x1.8p+1) 2.00 (0x1p+1) 1.00 (0x1p+0) 0.07 (0x1.242124p-4) 0.07 (0x1.242124p-4) ...]),
    ...
    rParams(Penvval, MAX_ENVELOPE_POINTS,
        ...
        rPreset(ad_voice_fm_wave, [0 127 127 0 64 64 ...]),
