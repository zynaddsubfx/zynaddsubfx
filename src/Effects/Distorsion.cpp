...
rtosc::Ports Distorsion::ports = {
    ...
    rEffParPan(),
    rEffPar(Plrcross, 2, rShort("l/r"), rLinear(0, 127), rDefault(35), 
            "Left/Right Crossover"),
    rEffPar(Pdrive,   3, rShort("drive"),
            rLinear(0, 127), rPresets(56, 29, 75, 85, 63, 88),
            "Input amplification"),
    rEffPar(Plevel,   4, rShort("output"),
            rLinear(0, 127), rPresets(70, 75, 80, 62, 75, 75),
    ...
    rEffPar(Plpf, 7, rShort("lpf"), rLinear(0, 127),
            rPreset(0, 96), rPreset(4, 55), rDefault(127), "Low Pass Cutoff"),
    rEffPar(Phpf, 8, rShort("hpf"), rLinear(0, 127),
